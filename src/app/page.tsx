...
export default function Page() {
	...
	return (
		<main className="px-[12%] py-[8%] space-y-[15%] mb-[100px]">
			<div className="rounded-2xl bg-white border flex justify-between items-center">
				<p className="text-blue-500 font-bold">Laundry Hub</p>
				<div>
					<Link href="#">Home</Link>
					<Link href="#">How its work</Link>
					<Link href="#">Why Choosee Us</Link>
					<Button className="bg-blue-500 hover:bg-blue-400 text-white font-semibold rounded-xl">
						Book Now
					</Button>
				</div>
			</div>
