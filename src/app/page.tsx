    ...
    <main className="px-[12%] py-[8%] space-y-[15%] mb-[100px]">
      <div className=" flex justify-center items-center">
        <div className="flex justify-between items-center bg-white border rounded-3xl p-3 w-[70%]">
          <p className="text-blue-500 font-bold flex justify-start">Laundry Hub</p>
          <div className="flex justify-end items-center gap-3">
            <Link href="#">Home</Link>
            <Link href="#">How its work</Link>
            <Link href="#">Why Choosee Us</Link>
            <Link href="/auth/sign-in" className="p-2 text-sm bg-blue-500 hover:bg-blue-400 text-white font-semibold rounded-xl">
              Book Now
            </Link>
          </div>
        </div>
