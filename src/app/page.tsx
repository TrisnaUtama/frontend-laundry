	...
	return (
		<main className="px-[12%] py-[8%] space-y-[15%] mb-[100px]">
			<div className=" flex justify-center items-center">
				<div className="flex justify-between items-center bg-white border rounded-3xl p-3 w-[70%]">
					...
					<div className="flex justify-end items-center gap-4">
						...
						<Link
							href="/auth/sign-in"
							className="p-2 text-sm bg-blue-500 hover:bg-blue-400 text-white font-semibold rounded-xl"
						>
							Book Now
						</Link>
					</div>
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
						{services && services.length > 0 ? (
							services.slice(0, 3).map((val, index) => (
								...
								>
									<Card className="bg-transparent mt-5 border-blue-500 rounded-lg transition-colors duration-300 hover:bg-blue-500 hover:text-white hover:shadow-md">
										<CardHeader>
